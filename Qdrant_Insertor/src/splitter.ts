...
export function splitDocument(
  ...
  switch (strategy) {
    ...
    case 'fixed-size':
      return splitByFixedSize(document.content, chunkSize, chunkOverlap);
    case 'sentence':
      return splitBySentence(document.content, undefined, undefined); // Pass undefined for minLen, maxLen to use defaults
    default:
      console.warn(
