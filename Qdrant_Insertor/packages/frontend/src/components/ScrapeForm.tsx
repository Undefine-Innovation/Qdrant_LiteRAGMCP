...
export const ScrapeForm: React.FC<ScrapeFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : 'Failed to start scrape task';
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) =>
              setConfig(prev => ({ ...prev, followLinks: e.target.checked }))
            }
            className="rounded"
          />
          <label
          ...
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      updateSelectors('title', e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      updateSelectors('content', e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      updateSelectors('links', e.target.value)
                    }
                    placeholder="a[href]"
                    className="input w-full text-sm"
                  />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  setConfig(prev => ({ ...prev, userAgent: e.target.value }))
                }
                className="input w-full text-sm"
              />
            </div>
