...
describe('Golden path e2e - Documents (integration copy)', () => {
  ...
  it.skip('happy path: upload a file to an existing collection and get it back', async () => {
    // create a collection
  ...
  it.skip('failure path: uploading to non-existent collection returns current behavior', async () => {
