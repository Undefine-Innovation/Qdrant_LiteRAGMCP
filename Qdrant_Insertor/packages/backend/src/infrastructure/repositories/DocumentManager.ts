...
import { DocId, DocumentChunk, Doc } from '@domain/entities/types.js';
...
export class DocumentManager {
   ...
   * @param docs.create - 创建文档的方法
   * @param docs.hardDelete - 硬删除文档的方法
   * @param docs.chunkMeta - 块元数据表
   * @param docs.chunksFts5 - 块全文搜索表
   ...
   * @returns 更新后的 Doc 对象，如果未找到原始文档则返回null
   */
  updateDoc(
    docId: DocId,
