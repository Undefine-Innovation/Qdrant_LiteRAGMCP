...
export const apiE2eTestGuide = {
  ...
  runCommands: {
    ...
    coverage: 'npm run test:integration -- --testPathPattern=tests/integration/api/*-e2e.test.ts --coverage',
    specific: 'npm run test:integration -- --testPathPattern=tests/integration/api/[test-file-name]',
  },
  requirements: {
    node: '>= 16.0.0',
    jest: '>= 29.0.0',
