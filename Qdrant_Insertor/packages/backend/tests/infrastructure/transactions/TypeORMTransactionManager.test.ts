...
describe('TypeORMTransactionManager', () => {
  ...
  describe('beginNestedTransaction', () => {
    it('应该创建嵌套事务并创建保存点', async () => {
      ...
      expect(mockQueryRunner.createSavepoint).toHaveBeenCalled();
      expect(mockLogger.info).toHaveBeenCalledWith(
  ...
  describe('rollback', () => {
    ...
    it('应该成功回滚嵌套事务到保存点', async () => {
      ...
      expect(mockQueryRunner.rollbackToSavepoint).toHaveBeenCalled();
      expect(mockLogger.info).toHaveBeenCalledWith(
  ...
  describe('savepoints', () => {
    it('应该创建保存点', async () => {
      ...
      expect(mockQueryRunner.createSavepoint).toHaveBeenCalledWith(savepointId);
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Savepoint created',
        expect.any(Object),
      );
    ...
    it('应该回滚到保存点', async () => {
      ...
      expect(mockQueryRunner.rollbackToSavepoint).toHaveBeenCalledWith(
        savepointId,
      );
      expect(mockLogger.info).toHaveBeenCalledWith(
    ...
    it('应该释放保存点', async () => {
      ...
      expect(mockQueryRunner.releaseSavepoint).toHaveBeenCalledWith(
        savepointId,
      );
      expect(mockLogger.info).toHaveBeenCalledWith(
        'Savepoint released',
  ...
  describe('executeOperation', () => {
    ...
    it('应该执行块创建操作', async () => {
      ...
      mockQueryRunner.manager.findOne.mockResolvedValue(null);
      mockQueryRunner.manager.save.mockResolvedValue({ pointId, ...chunkData });
  ...
  describe('deleteCollectionInTransaction', () => {
    it('应该在事务中删除集合', async () => {
      ...
      mockQueryRunner.manager.transaction.mockImplementation((fn) => fn());
